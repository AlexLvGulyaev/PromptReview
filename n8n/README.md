...
Реализация сценариев v3 — интеграция n8n с AI-компонентами для анализа качества промптов.
...
![Workflow: n8n + LangFlow](../docs/screenshots/PR_v3_flow_langflow_scenario1.png)

![Workflow: n8n + LangChain](../docs/screenshots/PR_v3_flow_langchain_scenario2.png)

![Полный workflow n8n + LangFlow](../docs/screenshots/PR_v3_flow_langflow_full.png)

## ⚙️ 4. Конвейер обработки (Сценарий 2)
...
![Результат: не промпт](../docs/screenshots/PR_v3_result_not_prompt.png)

![LangFlow: не промпт](../docs/screenshots/PR_v3_result_langflow_not_prompt.png)
...
## ↩️ 11. Связь с предыдущими этапами

| Этап | Технология | Статус | Описание |
|------|------------|--------|----------|
| **v1** | LangFlow (прототип) | ✅ Завершён | Прототип Prompt Review Agent |
| **v2** | LangChain | ✅ Завершён | Локальная реализация с двумя режимами |
| **v3.1** | n8n + LangFlow | ✅ Завершён | Первый сценарий |
| **v3.2** | n8n + LangChain | ✅ Завершён | Второй сценарий |

**Результаты v1** послужили основой для архитектуры LangFlow-компонента в v3.1.

**Результаты v2** предоставили альтернативную реализацию для сравнения архитектур и перенос кода в v3.2.

**Сравнение сценариев v3:**
...
**Важно:** Это только фиксация архитектурных идей. Ничего из перечисленного не реализовано в текущем сценарии v3.

## 🚀 13. Дальнейшее использование
...
- Как наглядный пример интеграции LangChain в n8n
- Как отправная точка для расширения конвейера обработки

---

**Статус:** актуален; n8n-контур v3
**Последнее обновление:** 2026-09-16
**История изменений:** [📝 docs/CHANGE_LOG.md](../docs/CHANGE_LOG.md#-1-история-изменений-документации)