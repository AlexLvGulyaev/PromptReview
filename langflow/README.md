...
![LangFlow интерфейс (Preseil)](../docs/screenshots/PR_v1_ui_langflow_presail.png)

![LangFlow интерфейс (Student)](../docs/screenshots/PR_v1_ui_langflow_student.png)
...
**Статус:** актуален; фоллбэк-backend
